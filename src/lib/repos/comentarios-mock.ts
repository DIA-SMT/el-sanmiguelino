...
/**
 * Motor en memoria de comentarios y votos. Singleton en globalThis para
 * sobrevivir al hot-reload de desarrollo.
 *
 * Sirve para levantar el proyecto sin credenciales: los comentarios de muestra
 * son suyos, y se pierden al reiniciar. El motor real es
 * `comentarios-postgres.ts`; el que se usa lo elige `comentarios.ts`.
 *
