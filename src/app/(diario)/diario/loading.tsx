...
/** Igual que el esqueleto de la nota: lleva el nombre de transición para que la
 *  hoja que entra gire aunque la portada todavía no haya llegado. El porqué
 *  largo está en `nota/[slug]/loading.tsx`. */
