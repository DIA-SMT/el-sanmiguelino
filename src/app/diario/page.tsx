  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-6 sm:px-6">
        {/* Titular central */}
        <h2 className="text-center font-display text-3xl font-black leading-[1.08] text-ink sm:text-5xl">
          <Link
          ...
          <article className="border border-line bg-bg p-4 md:col-span-3">
            ...
            {comentarioDestacado ? (
              ...
              <p className="mt-2 font-serif text-sm italic leading-relaxed text-ink-2">
                Todavía no hay opiniones en esta edición. La primera puede ser la
                tuya.
              </p>
            )}
            <Link
